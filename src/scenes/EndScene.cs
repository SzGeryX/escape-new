...
public class EndScene : IScene
{
    ...
    private const string deathMsg = "Your're Dead!";
    private const string restartBtnString = "Restart";

    public EndScene( ContentManager contentManager, SceneManager sceneManager, GraphicsDeviceManager graphics, GraphicsDevice graphicsDevice) {
